...
$updatecopy=update_copypro($_POST['click'], $_POST['selec'], $_POST['iframe'], $_POST['drop']);
	...
	global $wpdb;
	$fivesdrafts = $wpdb->get_results("SELECT*FROM wp_copyrightpro");
...
<body>
<div align="center">
  <p class="style1"><img src="<?php echo plugins_url('wp-copyrightpro/images/copyrightpro.png');?>" /></p>
  <form id="form1" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?page=<?php echo plugin_basename(__FILE__); ?>"><div align="left"><center><table width="716" border="0">
        <tr>
          <td><p><img src="<?php echo plugins_url('wp-copyrightpro/images/p'.$nuncopy.'.png');?>" /></p>
            ...
            <p align="left"><strong>Please select the protections to activate in your Wordpress.</strong><br />
              ...
              <input type="checkbox" name="iframe" id="checkbox3" value="y" <?php if ($result[2]=="y"){?>checked<?php }?> />
              Protects from iframes.<br />
              <input type="checkbox" name="drop" id="checkbox4" value="y" <?php if ($result[3]=="y"){?>checked<?php }?> />
